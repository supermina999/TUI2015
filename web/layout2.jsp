			...
			<footer id="footer">
									...
									<div class="row">
										<div class="col-sm-6">
											...
											<ul class="social-links circle">
												<li class="facebook"><a target="_blank" href="../../../../../facebook.com"><i class="fa fa-facebook"></i></a></li>
												...
												<li class="skype"><a target="_blank" href="../../../../../skype.com"><i class="fa fa-skype"></i></a></li>
												<li class="linkedin"><a target="_blank" href="../../../../../linkedin.com"><i class="fa fa-linkedin"></i></a></li>
											</ul>
										</div>
										<div class="col-sm-6">
											<ul class="list-icons">
				...
				<div class="subfooter">
					<div class="container">
						<div class="row">
							<div class="col-md-6">
								<p>Copyright © 2014 iDea by <a target="_blank" href="../../../../index.htm">HtmlCoder</a>. All Rights Reserved</p>
							</div>
							<div class="col-md-6">
