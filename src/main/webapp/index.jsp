        ...
        <div class="row">
            <div class="col-md-5">
                <form class="form-text center-block" style="margin-top: 0px;">
                    <p style="font-size: 18px;"> <strong><a href="about.jsp">
                                Команда XLV</a></strong>, представляющая Харьковский УВК №45 "Академическая гимназия", разработала и реализовала инструмент, который позволяет вести базы данных волонтеров, имеющихся ресурсов и потребностей в этих ресурсах, включает в себя систему эффективного управления запасами, распределения ресурсов, автоматического определения оптимальных маршрутов в динамике.
                    </p>
                </form>
            </div>
            <div class="col-md-6">
