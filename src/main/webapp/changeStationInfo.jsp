...
<div class="form-block center-block" style="width: 50%; min-height: 700px;">
    <center><h2 class="title">Изменить информацию о пункте выдачи №<%=station.getId()%></h2></center>
    <hr>
    <form class="form-horizontal" method = "post" action = "updateStationInfo.jsp?id=<%=Integer.parseInt(s)%>">
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="address" id="address" required value="<%=station.getLocation().getAddress()%>">
